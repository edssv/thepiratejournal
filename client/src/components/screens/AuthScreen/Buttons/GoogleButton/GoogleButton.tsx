...
const GoogleButton: React.FC<GoogleButtonProps & React.ButtonHTMLAttributes<HTMLButtonElement>> = ({
  ...
  return (
    <button className={clsx(styles.root, styles[size])} onClick={loginGoogle} {...props}>
      <svg aria-hidden='true' data-social-button-type='icon' focusable='false' role='img' viewBox='0 0 1152 1152'>
        <path
