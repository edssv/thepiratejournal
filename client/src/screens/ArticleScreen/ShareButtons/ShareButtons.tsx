...
export const ShareButtons: React.FC<{
  ...
  title: string;
  articleId: string;
}> = ({ mode, title, articleId }) => {
  const category = mode === ArticlePageMode.ARTICLE ? 'articles' : 'blog';
  ...
  return (
    ...
    >
      <Button
        ...
        href={getPublicUrl.shareVk(category, articleId)}
        target='_blank'
        variant='filledTonal'
      >
        <svg
      ...
      <Button
        ...
        as='a'
        className={styles.link}
        href={getPublicUrl.shareTwitter(title, category, articleId)}
        target='_blank'
        variant='filledTonal'
      >
        <svg
	...
	c-0.2,0.7-0.7,1.2-1.3,1.6c0.6-0.1,1.1-0.2,1.7-0.5C18.6,7.9,18.1,8.4,17.6,8.8z'
      ...
      <Button
        ...
        as='a'
        className={styles.link}
        href={getPublicUrl.shareFacebook(category, articleId)}
        target='_blank'
        variant='filledTonal'
      >
        <svg
