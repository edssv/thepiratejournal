...
export const ShareButtons = () => {
    const { data, mode } = useTypedSelector((state) => state.articlePage);
    ...
    return (
        ...
        >
            <Button
                href={getPublicUrl.shareVk(category, data.id)}
                target="_blank"
            ...
            <Button
                href={getPublicUrl.shareTwitter(data.title, category, data.id)}
                target="_blank"
                className={styles.link}
                variant="filledTonal"
	...
	c-0.2,0.7-0.7,1.2-1.3,1.6c0.6-0.1,1.1-0.2,1.7-0.5C18.6,7.9,18.1,8.4,17.6,8.8z"
            ...
            <Button
                href={getPublicUrl.shareFacebook(category, data.id)}
                target="_blank"
                className={styles.link}
                variant="filledTonal"
