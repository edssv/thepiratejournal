...
export const DialogControls: React.FC<React.PropsWithChildren<DialogControlsProps>> = ({
    children,
    className,
}) => {
...
export const DialogActionButton: React.FC<React.PropsWithChildren<ActionButtonProps>> = ({
    children,
    ...props
}) => {
    return (
...
export const DialogCancelButton: React.FC<React.PropsWithChildren<CancelButtonProps>> = ({
    children,
    ...props
}) => {
    return (
