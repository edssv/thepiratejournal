                        ...
                        var r,
                            ...
                            d =
                                ...
                                (u = function () {
                                    ...
                                    if (
                                        ...
                                        t.type &&
                                            ('string' != typeof t.type ||
                                                !Object.values(r).includes(t.type)))
                                    )
                                        throw new Error(
                                    ...
                                    if (
                                        ((t.progress = t.progress || function (t) {}),
                                ...
                                (c = function (t) {
                                    switch (t.method) {
                                        ...
                                        case 'UPDATE':
                                            ...
                                            (f.isFormData(t.data) || f.isFormElement(t.data)) &&
                                                (n = r.FORM),
                                                (t.data = s(t.data, n)),
                                                n !== d.contentType.FORM &&
                                    ...
                                    transport: function (t) {
                                        return (
                                            ...
                                            f.selectFiles(t).then(function (e) {
                                                for (
                                                    var n = new FormData(), o = 0;
                                                    o < e.length;
                                                    o++
                                                )
                                                    n.append(t.fieldName, e[o], e[o].name);
                                                f.isObject(t.data) &&
                ...
                if ('undefined' != typeof Symbol && Symbol.iterator in Object(t)) {
                    ...
                    try {
                        for (
                            ...
                            !(o = (a = u.next()).done) && (n.push(a.value), !e || n.length !== e);
                            o = !0
                        );
                    } catch (t) {
                        (r = !0), (i = t);
                            ...
                            [
                                {
                                    ...
                                    value: function (e) {
                                        return (
                                            e.file && 0 !== Object.keys(e.file).length
                                    ...
                                    value: function () {
                                        ...
                                        return (
                                            (e.innerHTML =
                                                ...
                                                ''
                                                    .concat(h.a, ' ')
                                                    .concat(this.api.i18n.t('Select an Image'))),
                                        ...
                                        'VIDEO' === o &&
                                            ...
                                            this.nodes.imageEl.addEventListener(i, function () {
                                                n.toggleStatus(t.status.FILLED),
                                                    n.nodes.imagePreloader &&
                                                        (n.nodes.imagePreloader.style.backgroundImage =
                                                            '');
                                            }),
                                            this.nodes.imageContainer.appendChild(
                                                this.nodes.imageEl,
                                            );
                                    },
                                },
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        for (var n in t.status)
                                            Object.prototype.hasOwnProperty.call(t.status, n) &&
                                                this.nodes.wrapper.classList.toggle(
                                                    ''
                                                        .concat(this.CSS.wrapper, '--')
                                                        .concat(t.status[n]),
                                                    e === t.status[n],
                                                );
                                    },
                                },
                                {
                                    ...
                                    value: function (t, e) {
                                        this.nodes.wrapper.classList.toggle(
                                            ''.concat(this.CSS.wrapper, '--').concat(t),
                                            e,
                                        );
                                    },
                                },
                                ...
                                },
                                {
                                    ...
                                    value: function (t, e) {
                                        ...
                                        n.classList.toggle(
                                            ...
                                            !n.classList.contains(this.CSS.buttonActive),
                                        ),
                                            this.onChange(t);
                                    },
                                },
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    ...
                                    'function' == typeof this.config.uploader.uploadByUrl
                                        ? F((e = this.config.uploader.uploadByUrl(t))) ||
                                          console.warn(
                            ...
                            },
                            {
                                ...
                                value: function (t, e) {
                                    ...
                                    if (
                                        ...
                                        F((n = this.config.uploader.uploadByFile(t))) ||
                                            console.warn(
                                                'Custom uploader method uploadByFile should return a Promise',
                                            );
                                    else {
                                ...
                                value: function (t) {
                                    t.success && t.file
                                        ...
                                        : this.uploadingFailed(
                                              'incorrect response: ' + JSON.stringify(t),
                                          );
                                },
                            },
                            {
