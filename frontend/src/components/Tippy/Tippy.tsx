import React, { PropsWithChildren, RefAttributes, useEffect, useRef } from 'react';
import ReactDOM from 'react-dom';
import { useLocation, useNavigate } from 'react-router-dom';
import { AnimatePresence, motion } from 'framer-motion';
import { Popper, PopperChildrenProps, PopperProps, usePopper } from 'react-popper';
            ...
            <>
                ...
                {ReactDOM.createPortal(
                    <div ref={tippyRef} style={popperStyles.popper} {...attributes}>
                        <AnimatePresence>
                            {isOpen && <Component setIsOpen={setIsOpen} title={title} description={description} />}
                        </AnimatePresence>{' '}
                    </div>,
                    portalRoot
                )}
