...
import { isOpenHamburgerMenuSelector, setIsOpenHamburgerMenu, useLogoutMutation } from '@/store';
            ...
            <div ref={ref} className={`${styles.root} ${isOpen ? styles.open : ''}`}>
                ...
                {user && (
                    <div className={styles.profile}>
                        <Link href={`/@${user.username}`} onClick={() => dispatch(setIsOpenHamburgerMenu(false))}>
