...
import { articleDataSelector, useLikeCommentMutation, useRemoveLikeCommentMutation } from '@/store';
...
export const ButtonLike: React.FC<React.PropsWithChildren<IsLikeProps>> = ({
    commentId,
    isLike,
    children,
    tooltipPosition,
