...
import { articleDataSelector, articlePageModeSelector } from '@/store';
...
export const ShareButtons = () => {
    ...
    return (
        <div className={styles.root}>
            <Button
                href={`https://vk.com/share.php?url=${process.env.NEXT_PUBLIC_CLIENT_URL}/${
            ...
            <Button
                ...
                }/${mode === 'blog' ? 'blog' : 'articles'}/${article._id}`}
                target="_blank"
                className={styles.link}
                variant="filledTonal"
	...
	c-0.2,0.7-0.7,1.2-1.3,1.6c0.6-0.1,1.1-0.2,1.7-0.5C18.6,7.9,18.1,8.4,17.6,8.8z"
            ...
            <Button
                href={`https://www.facebook.com/sharer/sharer.php?u=${process.env.NEXT_PUBLIC_CLIENT_URL}/${
                    mode === 'blog' ? 'blog' : 'articles'
                }/${article._id}`}
                target="_blank"
                className={styles.link}
