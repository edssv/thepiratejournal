...
export const { setIsOpenHamburgerMenu, setIsOpenNavRail, setPublishSnackbarVisible } =
    slice.actions;
...
export const publishSnackbarVisibleSelector = (state: RootState) =>
    state.ui.isPublishSnackbarVisible;
