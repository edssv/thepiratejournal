...
export const FindMore = () => {
    return (
        <section className={`${styles.root} homeSection`}>
            <div className="contentContainer">
                <div className="sectionHeader">
                    <h2>Смотреть больше</h2>
                    <p className={styles.headerDescription}>
                        Больше статей ты сможешь найти в разделе "Поиск"
                    </p>
                </div>
                <Link href="/search" className={styles.card}>
                    <div className={styles.contentContainer}>
                        ...
                        <span className={styles.description}>
                            Находи статьи, которые тебе по вкусу. Используя сортировку, фильтрацию и
                    ...
                    <div className={styles.iconBadge}>
                        ...
                        <span className={`${styles.symbol} material-symbols-outlined`}>search</span>
                    </div>
                </Link>
            </div>
        </section>
