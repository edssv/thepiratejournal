...
export const CardLayout: React.FC<PropsWithChildren> = ({ children }) => {
    ...
    return (
        <div
            style={!isOnline ? { borderTopLeftRadius: 0, borderTopRightRadius: 0 } : { borderRadius: isMobile ? 0 : 8 }}
        ...
        >
            <header className={styles.header}>
                ...
                <h2>{activeSection === 'login' ? 'Войти' : activeSection === 'signup' && 'Создать учетную запись'}</h2>
            </header>
